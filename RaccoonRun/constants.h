...
//raccoon cel
const int RACCOON_COLS = 4;				//4
const int RACCOON_WIDTH = 86;			//86
const int RACCOON_HEIGHT = 50;			//50
const int RACCOON_HALF_WIDTH = 43;		//43
const int RACCOON_HALF_HEIGHT = 25;		//25
